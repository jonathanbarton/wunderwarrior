...
#
# However, when we do this, we also import `wunderwarrior/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'wunderwarrior_cli = wunderwarrior.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'wunderwarrior_gui = wunderwarrior.gui:entry_point'
        # ]
    }
)
